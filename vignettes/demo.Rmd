---
title: "Demonstrating ethsign"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Demonstrating ethsign}
...
This vignette demonstrates the two main functions in `ethsign`:
...
```{r setup}
box::use(ethsign[ add, sum_array_cpp ])
```
